<template>
    <div div v-if="isAuthenticated">
        <header class="mx-8 mt-8">
            <nav class="flex justify-between text-gray-500 items-center">
                <NuxtLink class="decoration-none font-bold tracking-widest text-3xl" to="/dashboard">DASHBOARD</NuxtLink>
                <ul>
    ...
    <div v-else>
        <main class="mx-8 mt-8 flex text-gray-500 items-center justify-center h-[90vh]">
            <p>Please <NuxtLink class="text-blue-500 font-bold" to="/login">log in </NuxtLink>to access the dashboard.</p>
        </main>
    </div>
</template>
